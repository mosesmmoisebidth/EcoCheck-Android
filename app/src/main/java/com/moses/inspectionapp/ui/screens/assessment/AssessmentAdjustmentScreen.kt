...
fun AssessmentAdjustmentScreen(
    ...
    val totalFine by animateIntAsState(targetValue = adjustmentAmount, label = "totalFine")
                        ...
                        StaggeredAnimatedItem(index = 0) {
                            Surface(
                                ...
                                Row(
                                    ...
                                    Text(
                                        text = "Set the final charge amount here. Question scoring uses marks, and reason is required when charging.",
                            ...
                            Surface(
                                ...
                                Row(
                                    ...
                                    Column {
                                        ...
                                        Text(
                                            text = "Toggle to set a charge amount",
                                    ...
                                    Column(
                                        ...
                                        Row(
                                            ...
                                            OutlinedTextField(
                                                value = amount,
                                                onValueChange = { value ->
                                                    setAmount(value.filter { it.isDigit() })
                                                },
                                        ...
                                        Row(
                                            ...
                                            listOf(5000, 10000, 20000, 50000, 100000).forEach { quickAmount ->
                                                val selected = amountValue == quickAmount
                    ...
                    item {
                        Surface(
                            ...
                            Column(
                                ...
                                LabelValueRow(label = "Inspection Score", value = "${scoreSummary.scoreOutOf100}/100")
                                DividerLine()
                                val adjustmentColor = if (adjustmentAmount > 0) {
